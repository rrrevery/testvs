...
namespace EMR.WinformDesigner
{
	...
	public class ToolboxUIManagerVS
	{
		...
		private void ConfigureControls()
		{
			...
			listBox.Location = new System.Drawing.Point(0, (Toolbox.Tabs.Count) * 20);
			listBox.Name = "ToolsListBox";
			listBox.Size = new System.Drawing.Size(Toolbox.Width, Toolbox.Height - (Toolbox.Tabs.Count) * 20);
		...
		private void button_Click(object sender, EventArgs e)
		{
			...
			Toolbox.ToolsListBox.Location = new System.Drawing.Point(0, (index + 1) * 20);
			UpdateToolboxItems(index);
		}
		private void Toolbox_SizeChanged(object sender, EventArgs e)
		{
			Toolbox.ToolsListBox.Size = new System.Drawing.Size(Toolbox.Width, Toolbox.Height - (Toolbox.Tabs.Count) * 20);
		}
	}// class
}// namespace
