...
namespace EMR.WinformDesigner
{
    ...
    public class ToolboxXmlManager
    {
        ...
        private Type[] windowsFormsToolTypes = EMR.Controls.MyControlType.windowsFormsToolTypes;

        private Type[] userControlsToolTypes = EMR.Controls.MyControlType.componentsToolTypes;
        ...
        private class Strings
        {
            ...
            public const string WindowsForms = "微软控件";
            public const string Components = "Components";
            public const string Data = "Data";
            public const string UserControls = "自定义控件";
        }
