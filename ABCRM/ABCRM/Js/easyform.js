...
(function ($, window, document, undefined) {
    ...
    _easyform.prototype = {
        ...
        init: function () {
            ...
            //改写 submit 的属性，便于控制
            this.submit_button = this.form.find("#B_Save");//("input:submit");
        ...
        _check: function (submit) {
            ...
            var index;
            for (index in this.inputs) {
                if (this.inputs[index].input[0].attributes['data-easyform']) {
    ...
    _easyinput.prototype = {
        ...
        init: function () {
            ...
            if (!!this.rules && this.options["real-time"]) {
                this.input.on("blur", function () {
                    if (this.attributes['data-easyform']) {
        ...
        _error: function (rule, option) {
            ...
            if (false == this.is_error) {
                ...
                msg = !msg ? $(this.input).parent().prev()[0].innerText + "不能为空!" : msg;
