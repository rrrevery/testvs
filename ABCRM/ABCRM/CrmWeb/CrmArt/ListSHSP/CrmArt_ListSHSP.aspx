<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrmArt_ListSHSP.aspx.cs" Inherits="BF.CrmWeb.CrmArt.ListSHSP.CrmArt_ListSHSP" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <%=V_Head_WebArtList%>
    <script>
        vPageMsgID = '<%=CM_CRMGL_SHSPCX%>';
    </script>
    <script src="CrmArt_ListSHSP.js"></script>
</head>
