<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_HYJFFLFX.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.HYJFFLFX.CRMREPORT_HYJFFLFX" %>
...
<head runat="server">
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title></title>
    <%=V_HeadConfig %>
    <script src="CRMREPORT_HYJFFLFX.js"></script>
    <script type="text/javascript">
        vPageMsgID = '<%=CM_CRMREPORT_HYJFFLFX%>';
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">会员积分返利分析</a></li>
                    </ul>
