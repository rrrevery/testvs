<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_HYDJXFRBB.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.HYDJXFRBB.CRMREPORT_HYDJXFRBB" %>
...
<head runat="server">
    ...
    <title></title>
    <%=V_HeadConfig %>
    <script src="CRMREPORT_HYDJXFRBB.js"></script>
    <script type="text/javascript">
        vPageMsgID = '<%=CM_CRMREPORT_HYDJXFRBB%>';
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">会员等级消费日报表</a></li>
                    </ul>
