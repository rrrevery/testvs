<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_HYXZLS.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.HYXZLS.CRMREPORT_HYXZLS" %>
...
<head runat="server">
    ...
    <script src="CRMREPORT_HYXZLS.js"></script>
    <script type="text/javascript">
        vPageMsgID = <%=CM_CRMREPORT_HYXZLS%>;
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">会员新增与流失分析</a></li>
                    </ul>
