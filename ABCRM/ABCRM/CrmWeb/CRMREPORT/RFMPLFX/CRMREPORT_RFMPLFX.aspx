<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_RFMPLFX.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.RFMPLFX.CRMREPORT_RFMPLFX" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="CRMREPORT_RFMPLFX.js"></script>
    <script type="text/javascript">
        vPageMsgID = <%=CM_CRMREPORT_RFMPLFX%>;
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">客群品类金额分析</a></li>
