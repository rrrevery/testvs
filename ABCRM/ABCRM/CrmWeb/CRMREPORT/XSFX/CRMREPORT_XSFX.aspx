<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_XSFX.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.XSFX.CRMREPORT_XSFX" %>
...
<head runat="server">
    ...
    <script src="CRMREPORT_XSFX.js"></script>
    <script type="text/javascript">
        vPageMsgID = <%=CM_CRMREPORT_XSFX%>;
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">电商销售分析</a></li>
