<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYXF_BMPPXFHZ_Srch.aspx.cs" Inherits="BF.CrmWeb.HYXF.BMPPXFHZ.HYXF_BMPPXFHZ_Srch" %>
...
<head runat="server">
    ...
    <title></title>
    <%=V_Head_Search %>
    <script>vPageMsgID = '<%=CM_HYXF_BMSBXF%>';</script>
    <script src="HYXF_BMPPXFHZ_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
