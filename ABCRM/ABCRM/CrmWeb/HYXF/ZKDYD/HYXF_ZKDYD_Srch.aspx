<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYXF_ZKDYD_Srch.aspx.cs" Inherits="BF.CrmWeb.HYXF.ZKDYD.HYXF_ZKDYD_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_HYXF_SrchCurrZKLGZ%>';
    </script>
    <script src="HYXF_ZKDYD_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
