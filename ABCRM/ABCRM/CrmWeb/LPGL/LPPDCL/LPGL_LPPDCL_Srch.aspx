<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LPGL_LPPDCL_Srch.aspx.cs" Inherits="BF.CrmWeb.LPGL.LPPDCL.LPGL_LPPDCL_Srch" %>
...
<head runat="server">
    ...
    <script src="LPGL_LPPDCL_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
