<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_YHQPLQK_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.YHQPLQK.HYKGL_YHQPLQK_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = <%=CM_HYKGL_YHQZHPLQKCL%>;
    </script>
    <script src="HYKGL_YHQPLQK_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
