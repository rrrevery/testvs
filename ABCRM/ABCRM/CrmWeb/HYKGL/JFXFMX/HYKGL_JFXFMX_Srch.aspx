<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_JFXFMX_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.JFXFMX.HYKGL_JFXFMX_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_HYKGL_JFXFMX%>';
    </script>
    <script src="HYKGL_JFXFMX_Srch.js"></script>
</head>
<body>
    <div>
        ...
        <div id="SearchResult" class="bfbox">
            <div id="MDMX" class="common_menu_tit slide_down_title">
                <span>会员门店明细</span>

            </div>
            <div id="MDMX_Hidden" class="maininput">
                <table id="list"></table>
            </div>
            <div id="JFMX" class="common_menu_tit slide_down_title">
                <span>会员消费积分明细</span>

            </div>
            <div id="JFMX_Hidden" class="maininput">
                <table id="list_JFMX"></table>
            </div>
            <div id="SPMX" class="common_menu_tit slide_down_title">
                <span>商品消费明细</span>

            </div>
            <div id="SPMX_Hidden" class="maininput">
                <table id="list_SPMX"></table>
            </div>
        </div>
    </div>
</body>
