<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_MZKTS_Srch.aspx.cs" Inherits="BF.CrmWeb.MZKGL.MZKTS.MZKGL_MZKTS_Srch" %>
...
<head runat="server">
    ...
    <script src="MZKGL_MZKTS_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
        <div class="bffld">
            ...
            <div class="bffld_right">
                ...
                <input type="hidden" id="HF_FS" value="1" />
            </div>
        </div>
        <div class="bffld">
    ...
    <div class="bfrow">
        ...
        <div class="bffld">
            <div class="bffld_left">退售数量</div>
            <div class="bffld_right">
                <input id="TB_SKSL" type="text" />
            </div>
        </div>
    </div>
    <div class="bfrow">
