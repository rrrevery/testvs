<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_MZKJEPLZC_Srch.aspx.cs" Inherits="BF.CrmWeb.MZKGL.MZKJEPLZC.MZKGL_MZKJEPLZC_Srch" %>
...
<head runat="server">
    ...
    <script src="MZKGL_MZKJEPLZC_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
    ...
    <div class="bfrow">
        <div class="bffld">
            <div class="bffld_left">转储金额</div>
            <div class="bffld_right">
                <input id="TB_ZCJE" type="text" />
            </div>
        </div>
        <div class="bffld">
