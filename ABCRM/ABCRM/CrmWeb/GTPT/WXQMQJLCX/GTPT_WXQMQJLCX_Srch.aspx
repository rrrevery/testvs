<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GTPT_WXQMQJLCX_Srch.aspx.cs" Inherits="BF.CrmWeb.GTPT.WXQMQJLCX.GTPT_WXQMQJLCX_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_GTPT_WXQMQJLCX%>';
    </script>
    <script src="GTPT_WXQMQJLCX_Srch.js"></script>
