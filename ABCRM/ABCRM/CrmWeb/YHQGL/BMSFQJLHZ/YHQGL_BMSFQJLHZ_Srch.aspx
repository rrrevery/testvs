<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YHQGL_BMSFQJLHZ_Srch.aspx.cs" Inherits="BF.CrmWeb.YHQGL.BMSFQJLHZ.YHQGL_BMSFQJLHZ_Srch" %>
...
<head runat="server">
    ...
    <title></title>
    <%=V_Head_Search %>
    <script>vPageMsgID = '<%=CM_YHQGL_HZCXJLByXSBM%>';</script>
    <script src="YHQGL_BMSFQJLHZ_Srch.js"></script>
</head>
<body>
  <%=V_SearchBodyBegin %>
    <div class="bfrow">
