<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_CFGML.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.CFGML.CRMREPORT_CFGML" %>
...
<head runat="server">
    ...
    <script src="CRMREPORT_CFGML.js"></script>
    <script type="text/javascript">
        vPageMsgID = <%=CM_CRMREPORT_CFGML%>;
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">门店重复购买率分析</a></li>
                        <li><a href="#tab2">部门重复购买率分析</a></li>
                        <li style="display: none"><a href="#tab3">品类重复购买率分析</a></li>
                        <li><a href="#tab4">会员等级重复购买率分析</a></li>
                    </ul>
