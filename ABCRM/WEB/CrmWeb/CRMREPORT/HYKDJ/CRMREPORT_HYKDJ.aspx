<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_HYKDJ.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.HYKDJ.CRMREPORT_HYKDJ" %>
...
<head runat="server">
    ...
    <script src="CRMREPORT_HYKDJ.js"></script>
    <script type="text/javascript">
        vPageMsgID = <%=CM_CRMREPORT_HYKDJ%>;
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">会员门店客单价分析</a></li>
                        <li><a href="#tab2">会员部门客单价分析</a></li>
                        <li style="display: none"><a href="#tab3">会员品类客单价分析</a></li>
                        <li><a href="#tab4">会员日期客单价分析</a></li>
                    </ul>
