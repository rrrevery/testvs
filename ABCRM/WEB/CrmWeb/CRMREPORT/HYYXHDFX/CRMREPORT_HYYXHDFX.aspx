<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_HYYXHDFX.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.HYYXHDFX.CRMREPORT_HYYXHDFX" %>
...
<head runat="server">
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title></title>
    <%=V_HeadConfig %>
    <script src="CRMREPORT_HYYXHDFX.js"></script>
    <script type="text/javascript">
        vPageMsgID = '<%=CM_CRMREPORT_HYYXHDFX%>';
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">会员营销活动分析（年）</a></li>
                    </ul>
...
<%--                        商品分类
                        ...
                        营销活动
                        <input id="TB_HDZT" type="text" />
                        <input id="HF_YXHDID" type="hidden" />
                        <input id="zHF_YXHDID" type="hidden" />
