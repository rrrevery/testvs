...
function btnSrch1Click() {
    var addr = ReportServer + "?reportlet=HYGXD_MD.cpt";
...
function btnSrch2Click() {
    var addr = ReportServer + "?reportlet=HYGXD_BM.cpt";
...
function btnSrch3Click() {
    var addr = ReportServer + "?reportlet=HYGXD_PL.cpt";
...
function btnSrch4Click() {
    var addr = ReportServer + "?reportlet=HYGXD_RQ.cpt";
