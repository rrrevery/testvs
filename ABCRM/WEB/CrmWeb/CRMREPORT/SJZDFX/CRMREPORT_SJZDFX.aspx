<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_SJZDFX.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.SJZDFX.CRMREPORT_SJZDFX" %>
...
<head runat="server">
    ...
    <%=V_Head_Report %>
    <script src="CRMREPORT_SJZDFX.js"></script>
    <title></title>
</head>
<body>
    <%=V_JKPTBodyBegin %>
