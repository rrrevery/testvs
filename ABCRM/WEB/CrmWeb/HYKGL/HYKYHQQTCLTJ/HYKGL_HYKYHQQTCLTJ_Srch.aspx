<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_HYKYHQQTCLTJ_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.HYKYHQQTCLTJ.HYKGL_HYKYHQQTCLTJ_Srch" %>
...
<head runat="server">
    ...
    <title></title>
     <%=V_Head_Search %>
    <script>vPageMsgID = '<%=CM_HYKGL_YHQ_QTCLTJ%>';</script>
    <script src="HYKGL_HYKYHQQTCLTJ_Srch.js"></script>
</head>
<body>
        <div id='reg-form'>
