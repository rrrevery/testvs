<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_YHQZHCLJL_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.YHQZHCLJL.HYKGL_YHQZHCLJL_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_HYKGL_YHQZHCLJLCX%>';
    </script>
    <script src="HYKGL_YHQZHCLJL_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
    ...
    <div class="bfrow">
        ...
        <div class="bffld">
            <div class="bffld_left">截止日期</div>
            <div class="bffld_right">
                <input id="TB_JZRQ" type="text" class="Wdate" onfocus="WdatePicker()" />
            </div>
        </div>
    </div>
