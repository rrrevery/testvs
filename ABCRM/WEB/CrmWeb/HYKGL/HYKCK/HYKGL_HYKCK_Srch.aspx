<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_HYKCK_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.HYKCK.HYKGL_HYKCK_Srch" %>
...
<head runat="server">
    ...
    <script src="HYKGL_JEZCKCL_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
