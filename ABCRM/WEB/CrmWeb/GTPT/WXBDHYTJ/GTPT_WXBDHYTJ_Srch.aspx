<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GTPT_WXBDHYTJ_Srch.aspx.cs" Inherits="BF.CrmWeb.GTPT.WXBDHYTJ.GTPT_WXBDHYTJ_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_GTPT_WXBDHYTJ%>';
    </script>
    <script src="GTPT_WXBDHYTJ_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
