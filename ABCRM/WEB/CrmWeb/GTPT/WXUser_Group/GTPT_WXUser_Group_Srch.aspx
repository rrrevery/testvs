<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GTPT_WXUser_Group_Srch.aspx.cs" Inherits="BF.CrmWeb.GTPT.WXUser_Group.GTPT_WXUser_Group_Srch" %>
...
<head runat="server">
    ...
    <script src="GTPT_WXUser_Group_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
        ...
        <div class="bffld">
            ...
            <div class="bffld_right">
                <input id="TB_GROUPJL_NAME" type="text" tabindex="2" />
            </div>
        </div>
    </div>
    <div class="bfrow">
