<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_MZKCQK_Srch.aspx.cs" Inherits="BF.CrmWeb.MZKGL.MZKCQK.MZKGL_MZKCQK_Srch" %>
...
<head runat="server">
    ...
    <script>
        ...
        bCanEdit = CheckMenuPermit(iDJR, '<%=CM_MZKGL_MZKCQK_LR%>');
        bCanExec = CheckMenuPermit(iDJR, '<%=CM_MZKGL_MZKCQK_SH%>');
        bCanSrch = CheckMenuPermit(iDJR, '<%=CM_MZKGL_MZKCQK_CX%>');
    </script>
    <script src="MZKGL_MZKCQK_Srch.js"></script>
