<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_YXQYC_Srch.aspx.cs" Inherits="BF.CrmWeb.MZKGL.YXQYC.MZKGL_YXQYC_Srch" %>
...
<head runat="server">
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_MZKGL_YXQGG%>';
    </script>
    <script src="MZKGL_YXQYC_Srch.js"></script>
</head>
<body>
 <%=V_SearchBodyBegin %>
    <div class="bfrow">
