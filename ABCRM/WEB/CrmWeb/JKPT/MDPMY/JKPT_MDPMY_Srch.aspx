<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_MDPMY_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.MDPMY.JKPT_MDPMY_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_JKPT_MDPMY%>';
    </script>
    <script src="JKPT_MDPMY_Srch.js"></script>
</head>
<body>
  <%=V_JKPTBodyBegin %>
    <div class="bfrow">
