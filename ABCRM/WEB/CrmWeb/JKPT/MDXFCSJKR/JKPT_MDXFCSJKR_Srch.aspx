<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_MDXFCSJKR_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.MDXFCSJKR.JKPT_MDXFCSJKR_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_JKPT %>
    <script>
        vPageMsgID = '<%=CM_JKPT_MDXFR%>';
        var vPageMsgID_XFCSJK = '<%=CM_JKPT_XFCSJK%>';
    </script>
    <script src="JKPT_MDXFCSJKR_Srch.js"></script>
