<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_BMXFPMR_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.BMXFPMR.JKPT_BMXFPMR_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_JKPT_BMPMR%>';
    </script>
    <script src="JKPT_BMXFPMR_Srch.js"></script>
