<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_BMXFCSJKY_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.BMXFCSJKY.JKPT_BMXFCSJKY_Srch" %>
...
<head runat="server">
    ...
    <script src="JKPT_BMXFCSJKY_Srch.js"></script>
    <script>vPageMsgID = '<%=CM_JKPT_BMXFY%>';</script>
    ...
    <div class="bfrow">
        <div class="bffld">
            ...
            <div class="bffld_right">
                <input id="TB_RQ" type="text" class="Wdate" onfocus="WdatePicker({isShowWeek:true,dateFmt:'yyyyMM'})" />
            </div>
        </div>
        <div class="bffld">
