<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LPGL_LPZFCL_Srch.aspx.cs" Inherits="BF.CrmWeb.LPGL.LPZFCL.LPGL_LPZFCL_Srch" %>
...
<head runat="server">
    ...
    <script src="LPGL_LPZFCL_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
    ...
    <div class="bfrow">
        ...
        <div class="bffld">
            ...
            <div class="bffld_right">
                <input class="magic-radio" type="radio" name="DJZT" id="R_A" value="0" />
                <label for="R_A">全部</label>
