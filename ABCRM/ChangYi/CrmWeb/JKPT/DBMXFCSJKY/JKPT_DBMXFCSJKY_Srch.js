...
function InitGrid() {
	vColumnNames = ['月份', '月份', 'MDID', '门店名称', '消费会员数量', '交易次数', '最大交易次数', '前5平均交易次数', '前10平均交易次数', '前20平均交易次数'];
	vColumnModel = [
...
$(document).ready(function () {
	...
	$("#list").datagrid({
	    onDblClickRow: function (rowIndex, rowData) {
	        MakeNewTab("CrmWeb/JKPT/XFCSJK/JKPT_XFCSJK_Srch.aspx?DZLX=2&rq=" + rowData.iYEARMONTH + "&mdid=" + rowData.iMDID + "&max_xfcs=" + rowData.iMAX_XFCS + "&bmdm=" + $("#HF_BMDM").val(), "单部门消费次数日监控", vPageMsgID_XFCSJK);
	    }
	});
