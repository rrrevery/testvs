<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_DBMXFCSJKY_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.DBMXFCSJKY.JKPT_DBMXFCSJKY_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_JKPT_BMXFY_1%>';
        var vPageMsgID_XFCSJK = '<%=CM_JKPT_XFCSJK%>';
    </script>
    <script src="JKPT_DBMXFCSJKY_Srch.js"></script>
