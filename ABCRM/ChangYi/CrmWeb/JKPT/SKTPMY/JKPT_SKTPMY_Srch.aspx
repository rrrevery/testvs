<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_SKTPMY_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.SKTPMY.JKPT_SKTPMY_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_JKPT_SKTPMY%>';
    </script>
    <script src="JKPT_SKTPMY_Srch.js"></script>
</head>
<body>
    <%=V_JKPTBodyBegin %>
    <div class="bfrow">
