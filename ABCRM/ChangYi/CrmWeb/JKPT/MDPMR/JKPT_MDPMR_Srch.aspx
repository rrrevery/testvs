<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_MDPMR_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.MDPMR.JKPT_MDPMR_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_JKPT_MDPMR%>';
    </script>
    <script src="JKPT_MDPMR_Srch.js"></script>
</head>
<body>
    <%=V_JKPTBodyBegin %>
    <div class="bfrow">
