<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_BMXFPMY_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.BMXFPMY.JKPT_BMXFPMY_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_JKPT_BMPMY%>';
    </script>
    <script src="JKPT_BMXFPMY_Srch.js"></script>
