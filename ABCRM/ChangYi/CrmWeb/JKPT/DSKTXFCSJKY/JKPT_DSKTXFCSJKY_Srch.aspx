<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JKPT_DSKTXFCSJKY_Srch.aspx.cs" Inherits="BF.CrmWeb.JKPT.DSKTXFCSJKY.JKPT_DSKTXFCSJKY_Srch" %>
...
<head runat="server">
    ...
    <script>
        vPageMsgID = '<%=CM_JKPT_SKTXFY_1%>';
        var vPageMsgID_XFCSJK = '<%=CM_JKPT_XFCSJK%>';
    </script>
    <script src="JKPT_DSKTXFCSJKY_Srch.js"></script>
</head>
<body>
<%=V_JKPTBodyBegin %>
    <div class="bfrow">
