...
namespace BF.CrmWeb.GTPT
{
    ...
    /// 主要用来处理程序与微信服务器的交互操作
    /// </summary>
    public class GTPT_WX : System.Web.UI.Page, IHttpHandler
    {
        ...
        public override void ProcessRequest(HttpContext context)
        {
           ...
           //updateValue = context.Request.Form["json"].Replace("\\\"", "\"").Replace("\"{", "{").Replace("}\"", "}");
            ...
            switch (requestType.ToLower())
            {
                ...
                case "menu":
                    ...
                    break;
                case "news": //图文素材
                    wxbase = JsonConvert.DeserializeObject<WX_NEWS>(postData);
                    break;
                case "groupmessage": //群发消息
                    wxbase = JsonConvert.DeserializeObject<WX_GroupMessage>(postData);
                    break;
                default:
            ...
            result = wxbase.WXRequest(out msg, PUBLICID, PUBLICIF, mode, postData, "", "", context);
