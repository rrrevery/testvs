<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_HYKXF_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.HYKXF.HYKGL_HYKXF_Srch" %>
...
<head runat="server">
    ...
    <title></title>
    <%=V_Head_Search %>
    <script>vPageMsgID = '<%=CM_HYKGL_HYKXF%>'</script>
    <script src="HYKGL_HYKXF_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
