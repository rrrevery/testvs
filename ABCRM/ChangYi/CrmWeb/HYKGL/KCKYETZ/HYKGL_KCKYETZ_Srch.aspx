<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_KCKYETZ_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.KCKYETZ.HYKGL_KCKYETZ_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_HYKGL_KCKYETZD %>';
        bCanEdit = CheckMenuPermit(iDJR, <%=CM_HYKGL_KCKYETZD_LR%>);
        bCanExec = CheckMenuPermit(iDJR, <%=CM_HYKGL_KCKYETZD_SH%>);
        bCanSrch = CheckMenuPermit(iDJR, <%=CM_HYKGL_KCKYETZD_CX%>);
    </script>
    <script src="HYKGL_KCKYETZ_Srch.js"></script>
