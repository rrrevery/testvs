<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_YHQSSXFTJ_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.YHQSSXFTJ.HYKGL_YHQSSXFTJ_Srch" %>
...
<head runat="server">
    ...
    <title></title>
    <%=V_Head_Search %>
    <script>vPageMsgID = '<%=CM_HYKGL_YHQ_SSCX_XFTJ%>';</script>
    <script src="HYKGL_YHQSSXFTJ_Srch.js"></script>
</head>
<body>
        <div id='reg-form'>
        ...
        <div id='SearchResult' class='bfbox'>
            <div id='zMP1' class='common_menu_tit slide_down_title'><span>优惠券门店消费</span></div>
            <div id='zMP1_Hidden' class='maininput'>
                <table id='list'></table>
            </div>

            <div id='zMP2' class='common_menu_tit slide_down_title'><span>优惠券门店款台消费</span></div>
            <div id='zMP2_Hidden' class='maininput'>
                <table id='list1'></table>
            </div>

            <div id='zMP3' class='common_menu_tit slide_down_title'><span>优惠券门店款台收款员消费</span></div>
