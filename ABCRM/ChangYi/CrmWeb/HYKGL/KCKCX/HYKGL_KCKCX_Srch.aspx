<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_KCKCX_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.KCKCX.HYKGL_KCKCX_Srch" %>
...
<head id="Head1" runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_HYKGL_HYKBGKC_CX%>';
    </script>
    <script src="HYKGL_KCKCX_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
