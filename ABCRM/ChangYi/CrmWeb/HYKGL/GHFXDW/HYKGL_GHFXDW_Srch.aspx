<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_GHFXDW_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.GHFXDW.HYKGL_GHFXDW_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_HYKGL_GHFXDW%>';
    </script>
    <script src="HYKGL_GHFXDW_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
        ...
        <div class="bffld">
            ...
            <div class="bffld_left">新发行单位</div>
            <div class="bffld_right">
                <input id="TB_FXDW" type="text" />
