<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_HYKHS_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.HYKHS.HYKGL_HYKHS_Srch" %>
...
<head runat="server">
    ...
    <%=V_Head_Search %>
    <script>
        vPageMsgID = '<%=CM_HYKGL_HYKHS%>';
    </script>
    <script src="HYKGL_HYKHS_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
