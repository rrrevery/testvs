<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYKGL_HYKYHQXFTJ_Srch.aspx.cs" Inherits="BF.CrmWeb.HYKGL.HYKYHQXFTJ.HYKGL_HYKYHQXFTJ_Srch" %>
...
<head runat="server">
    ...
    <title></title>
    <%=V_Head_Search %>
    <script>vPageMsgID = '<%=CM_HYKGL_YHQ_XFTJ%>';</script>
    <script src="HYKGL_HYKYHQXFTJ_Srch.js"></script>
</head>
<body>
    <div id='reg-form'>
        ...
        <div id='SearchResult' class='bfbox'>
            ...
            <div id='zMP3' class='common_menu_tit slide_down_title'><span>优惠券门店款台消费</span></div>
