<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_MZKJEZC_Srch.aspx.cs" Inherits="BF.CrmWeb.MZKGL.MZKJEZC.MZKGL_MZKJEZC_Srch" %>
...
<head runat="server">
    ...
    <script src="MZKGL_MZKJEZC_Srch.js"></script>
</head>
<body>
 <%=V_SearchBodyBegin %>
    <div class="bfrow">
