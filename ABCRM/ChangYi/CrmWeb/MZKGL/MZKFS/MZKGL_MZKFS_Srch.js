...
function InitGrid() {
    vColumnNames = ['记录编号', '交款单标记', '交款单编号', '返利单标记', '返利单编号', '赠卡数', '赠卡金额', '赠礼数', '赠礼金额', '方式', 'MDID_CZMC', '操作门店', 'sBGDDDM', '保管地点', '售卡数量', '应收总额', '实收金额', '有效期', '状态', '摘要', 'DJR', '登记人', '登记时间', 'ZXR', '审核人', '审核日期', ];
    vColumnModel = [
