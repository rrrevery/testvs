<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_MZKTS.aspx.cs" Inherits="BF.CrmWeb.MZKGL.MZKTS.MZKGL_MZKTS" %>
...
<head runat="server">
    ...
    <%=V_Head_Input %>
    <script>
        vPageMsgID = '<%=CM_MZKGL_TS%>';
    </script>
    <script src="../../CrmLib/CrmLib_FillTree.js"></script>
    <script src="../../CrmLib/CrmLib_GetData.js"></script>
    <script src="MZKGL_MZKTS.js"></script>
</head>
<body>
    <%=V_InputBodyBegin %>
    <div class="bfrow">
    ...
    <div class="bfrow">
        <div class="bffld">
            <div class="bffld_left">退卡总金额</div>
            <div class="bffld_right">
                <label id="LB_SK_YSJE" style="text-align: left;">0</label>
            </div>
        </div>
        <div class="bffld">
            <div class="bffld_left">退卡总数</div>
            <div class="bffld_right">
    ...
    <div class="bfrow">
        ...
        <div class="bffld">
            <div class="bffld_left">退售券金额</div>
            <div class="bffld_right">
        ...
        <div id="zMP1_Hidden" class="maininput">
            ...
            <div class="bfrow" id="hyktype">
                <div class="bffld">
                    <div class="bffld_left">&nbsp;</div>
                    <div class="bffld_right">
                        <button id="AddItem" type='button' class="bfbut bfblue">查询</button>
                        <button id="DelItem" type='button' class="bfbut bfblue">删除</button>
                    </div>
                </div>
            </div>
    ...
    <div style="float: left; width: 50%;">
        ...
        <div id="zMP2_Hidden" class="maininput">
            <button id="R_ZFFS" type='button' class="bfbut bfblue" style="display:none">修改支付方式</button>
            <div class="bfrow bfrow_table">
