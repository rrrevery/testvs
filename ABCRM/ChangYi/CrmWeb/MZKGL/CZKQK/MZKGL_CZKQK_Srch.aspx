<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_CZKQK_Srch.aspx.cs" Inherits="BF.CrmWeb.MZKGL.CZKQK.MZKGL_CZKQK_Srch" %>
...
<head runat="server">
    ...
    <script>
        ...
        bCanEdit = CheckMenuPermit(iDJR, '<%=CM_MZKGL_QKCL_LR%>');
        bCanExec = CheckMenuPermit(iDJR, '<%=CM_MZKGL_QKCL_SH%>');
        bCanSrch = CheckMenuPermit(iDJR, '<%=CM_MZKGL_QKCL_CX%>');
    </script>
    <script src="MZKGL_CZKQK_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
