<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MZKGL_CZKCK_Srch.aspx.cs" Inherits="BF.CrmWeb.MZKGL.CZKCK.MZKGL_CZKCK_Srch" %>
...
<head runat="server">
    ...
    <script src="MZKGL_CZKCK_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
