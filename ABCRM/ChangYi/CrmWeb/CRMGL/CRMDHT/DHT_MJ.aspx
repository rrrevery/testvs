<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DHT_MJ.aspx.cs" Inherits="page2.CXMJ" %>
...
<body>
    ...
    <div class="bfrow">
        ...
        <div class="nav_right">
            ...
            <div class="nav_fld" menuid="<%=CM_YHQGL_CXMBJZDYD%>" >促销满减定义单</div>
        </div>
    </div>
    <%=V_DHTBodyEnd %>
    <script type="text/javascript">
        $("#bftitle").html("促销满减导航图");
            ...
            $(".nav_right .nav_fld").click(function () {
                ...
                switch (tabid) {
                    case "<%=CM_YHQGL_CXMBJZDYD%>":
                        tp_filename = "CrmWeb/HYXF/CXMBJZDYD/HYXF_CXMBJZDYD.aspx?mjjq=1";
                         break;
                 }
                if (tp_filename) {
