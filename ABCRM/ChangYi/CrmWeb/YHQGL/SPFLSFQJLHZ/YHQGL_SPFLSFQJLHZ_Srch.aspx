<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YHQGL_SPFLSFQJLHZ_Srch.aspx.cs" Inherits="BF.CrmWeb.YHQGL.SPFLSFQJLHZ.YHQGL_SPFLSFQJLHZ_Srch" %>
...
<head runat="server">
    ...
    <title></title>
    <%=V_Head_Search %>
    <script>vPageMsgID = '<%=CM_YHQGL_HZCXJLBySPFL%>';</script>
    <script src="YHQGL_SPFLSFQJLHZ_Srch.js"></script>
</head>
<body>
    <%=V_SearchBodyBegin %>
    <div class="bfrow">
