<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrmArt_ListXZLP.aspx.cs" Inherits="BF.CrmWeb.CrmArt.ListLP.CrmArt_ListXZLP" %>
...
<head runat="server">
    ...
    <%=V_Head_WebArtList%>
    <script>
        vPageMsgID = <%=CM_CRMART_CXLPXX%>;
    </script>
    <script src="CrmArt_ListXZLP.js"></script>
</head>
