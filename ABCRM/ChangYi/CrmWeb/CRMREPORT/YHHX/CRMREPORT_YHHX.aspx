<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_YHHX.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.YHHX.CRMREPORT_YHHX" %>
...
<head runat="server">
    ...
    <%=V_Head_Report %>
    <script src="CRMREPORT_YHHX.js"></script>
    <title></title>
</head>
<body>
    <%=V_JKPTBodyBegin %>
