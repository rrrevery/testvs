<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_HYXFSDXG.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.HYXFSDXG.CRMREPORT_HYXFSDXG" %>
...
<head runat="server">
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title></title>
    <%=V_HeadConfig %>
    <script src="CRMREPORT_HYXFSDXG.js"></script>
    <script type="text/javascript">
        vPageMsgID = '<%=CM_CRMREPORT_HYXFSDXG%>';
    </script>
    <script type="text/javascript">
            ...
            <div id="right_wrap">
                <div id="right_content">
                    ...
                    <ul id="tabsmenu" class="tabsmenu">
                        <li class="active"><a href="#tab1">按门店分析消费时段习惯</a></li>
                    </ul>
