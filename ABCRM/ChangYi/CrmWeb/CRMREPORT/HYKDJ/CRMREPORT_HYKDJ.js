...
function btnSrch1Click() {
    var addr = ReportServer + "?reportlet=HYKDJ_MD.cpt";
...
function btnSrch2Click() {
    var addr = ReportServer + "?reportlet=HYKDJ_BM.cpt";
...
function btnSrch3Click() {
    var addr = ReportServer + "?reportlet=HYKDJ_PL.cpt";
...
function btnSrch4Click() {
    var addr = ReportServer + "?reportlet=HYKDJ_RQ.cpt";
