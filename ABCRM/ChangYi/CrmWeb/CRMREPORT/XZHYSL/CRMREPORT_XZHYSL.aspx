<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRMREPORT_XZHYSL.aspx.cs" Inherits="BF.CrmWeb.CRMREPORT.XZHYSL.CRMREPORT_XZHYSL" %>
...
<head runat="server">
    ...
    <%=V_Head_Report %>
    <script src="CRMREPORT_XZHYSL.js"></script>
    <title></title>
</head>
<body>
    <%=V_JKPTBodyBegin %>
    ...
    <iframe class="iFrame" id="fr1" frameborder="no" style="height: 0px; width: 100%"></iframe>
    <%=V_InputBodyEnd %>
</body>
</html>
