...
{
    public class HYKGL_KCKBGZ_Srch : HYK_DJLR_CLass
    {
        ...
        public override List<Object> SearchDataQuery(CyQuery query, DateTime serverTime)
        {
            ...
            query.SQL.Text = "select W.*,D.HYKNAME,B.BGDDMC from HYK_KCCZKBGZ W,HYKDEF D,HYK_BGDD B";
        ...
        {
            HYKGL_KCKBGZ_Srch obj = new HYKGL_KCKBGZ_Srch();
