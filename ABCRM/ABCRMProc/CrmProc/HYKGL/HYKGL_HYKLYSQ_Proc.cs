...
{
    public class HYKGL_HYKLYSQ_Proc :DJLR_ZX_CLass
    {
        ...
        {
            ExecTable(query, "CARDLQSQJL", serverTime, "JLBH","ZXR","ZXRMC","ZXRQ",1);
            msg = string.Empty;
        }

        public override void DeleteDataQuery(out string msg, CyQuery query, DateTime serverTime)
        {
            CrmLibProc.DeleteDataTables(query, out msg, "CARDLQSQJL;CARDLQSQJLITEM", "JLBH", iJLBH);
        }
        ...
        public override void SaveDataQuery(out string msg, CyQuery query, DateTime serverTime)
        {
            ...
            if (iJLBH != 0)
            {
                ...
                iJLBH = SeqGenerator.GetSeq("CARDLQSQJL");
            query.SQL.Text = "insert into CARDLQSQJL(JLBH,BGDDDM_BR,HYKSL,BJ_CZK,STATUS,DJLX,BZ,DJR,DJRMC,DJSJ)";
            ...
            {
                query.SQL.Text = "insert into CARDLQSQJLITEM(JLBH,HYKTYPE,HYKSL)";
        ...
        public override List<object> SearchDataQuery(CyQuery query, DateTime serverTime)
        {
            ...
            if (lst.Count == 1)
            {
                ...
                while (!query.Eof)
                {
                    ...
                    ((HYKGL_HYKLYSQ_Proc)lst[0]).itemTable.Add(item);
        ...
        {
            ExecTable(query, "CARDLQSQJL", serverTime, "JLBH", "ZZR", "ZZRMC", "ZZRQ", 3);
            msg = string.Empty;
        }
    }
}
