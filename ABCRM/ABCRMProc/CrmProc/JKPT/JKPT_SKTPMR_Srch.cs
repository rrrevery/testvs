...
{
    public class JKPT_SKTPMR_Srch : BASECRMClass
    {
        public int iHYID = 0;
        ...
        public override List<Object> SearchDataQuery(CyQuery query, DateTime serverTime)
        {
            ...
            query.SQL.Add(",(select count(*) from HYK_KYJL L where L.HYID=X.HYID AND RQ=to_date(to_char(sysdate,'yyyy-mm-dd'),'yyyy-mm-dd') and DJR=100000001) KYCS");
            query.SQL.Add(",R.XSJE XFJE,R.JF,R.ZXJE,R.ZDJE,R.XFCS,R.THCS");
        ...
        {
            JKPT_SKTPMR_Srch obj = new JKPT_SKTPMR_Srch();
